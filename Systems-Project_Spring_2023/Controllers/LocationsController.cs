    ...
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var location = await _context.Location
                .FirstOrDefaultAsync(m => m.loc_id == id);
            if (location == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("loc_id,loc_name")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("loc_id,loc_name")] Location location)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!LocationExists(location.loc_id))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Location?.Any(e => e.loc_id == id)).GetValueOrDefault();
        }
    }
}
